...
$chart_labels = []; $chart_rev = []; $chart_sold_qty = []; $chart_import_qty = [];
for ($i = 6; $i >= 0; $i--) {
...
<style>
    ...
    .stat-desc { font-size: 12px; color: #999; } /* Đây là class chữ nhỏ bạn cần */
...
<div class="stats-section">
    ...
    <div class="stats-grid" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));">
        <a href="order_list.php?date=<?php echo $today; ?>" class="stat-card c-shift">
            <span class="stat-icon">⚡</span> <div class="stat-label">Doanh thu Ca</div> 
            <div class="stat-number"><?php echo number_format($rev_shift); ?> ₫</div>
            <div class="stat-desc">Đang cập nhật...</div>
        </a>
        <a href="order_list.php?date=<?php echo $today; ?>" class="stat-card c-shift">
            <span class="stat-icon">☕</span> <div class="stat-label">Đã Bán Ca này</div> 
